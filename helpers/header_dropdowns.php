...
function renderAccountMenu($fileRoot)
{
    if (isset($_SESSION['user_id'])) {
        ...
        if (isset($_SESSION['user_role']) && $_SESSION['user_role'] === 'admin') {
            echo '<li><a class="dropdown-item btn btn-account " href="' . $fileRoot . '/admin">Dashboard</a></li>';
        } else {
            echo '<li><a class="dropdown-item btn btn-account mb-2" href="' . $fileRoot . '/my-orders">My Orders</a></li>';
