...
<head>
    ...
    <style>
        ...
        @keyframes insta-carousel-animate {
            ...
            4.2857142857%, 14.2857142857% {
                visibility: visible;
                opacity: 0.8;
                transform: translateX(100%) scale(0.9);
            }
            18.5714285714%, 28.5714285714% {
                visibility: visible;
                opacity: 1;
                transform: translateX(0) scale(1);
            }
            32.8571428571%, 42.8571428571% {
                visibility: visible;
                opacity: 0.8;
                transform: translateX(-100%) scale(0.9);
            }
       ...
       /* Animation delays for each slide */
        .insta-section .insta-carousel .insta-item:nth-child(1) { animation-delay: calc(27s / 7 * -3); }
        .insta-section .insta-carousel .insta-item:nth-child(2) { animation-delay: calc(27s / 7 * -2); }
        .insta-section .insta-carousel .insta-item:nth-child(3) { animation-delay: calc(27s / 7 * -1); }
        .insta-section .insta-carousel .insta-item:nth-child(4) { animation-delay: calc(27s / 7 * 0); }
        .insta-section .insta-carousel .insta-item:nth-child(5) { animation-delay: calc(27s / 7 * 1); }
        .insta-section .insta-carousel .insta-item:nth-child(6) { animation-delay: calc(27s / 7 * 2); }
        .insta-section .insta-carousel .insta-item:nth-child(7) { animation-delay: calc(27s / 7 * 3); }
