            ...
            <div class="modal-content">
                ...
                <form action="stocks" method="post">
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            <label for="category_id" class="form-label">Category ID (1 drinks, 2 pastries, 3 waffles, 4
                                merienda)</label>
            ...
            <div class="modal-content">
                ...
                <form action="stocks" method="post">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            <label for="edit-category-id" class="form-label">Category ID (1 drinks, 2 pastries, 3
                                waffles, 4 merienda)</label>
