...
@media (max-width: 768px) {
    ...
    .orderBtn { font-size: 1rem; padding: 10px 30px; }
}

@media (max-width: 480px) {
    .cont { margin-top: 15vh; }
    .cont h2 { font-size: 1.6rem; }
    .cont p { font-size: 0.9rem; }
    .orderBtn { font-size: 0.9rem; padding: 8px 25px; }
}
</style>
