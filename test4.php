    ...
    <style>
        ...
        *::before {
        ...
        .carousel .item {
            ...
            animation: carousel-animate 20s cubic-bezier(0.37, 0, 0.63, 1) infinite;
        }
        ...
        .carousel .item:nth-child(1) { animation-delay: calc(20s / 7 * 0); }
        .carousel .item:nth-child(2) { animation-delay: calc(20s / 7 * 1); }
        .carousel .item:nth-child(3) { animation-delay: calc(20s / 7 * 2); }
        .carousel .item:nth-child(4) { animation-delay: calc(20s / 7 * 3); }
        .carousel .item:nth-child(5) { animation-delay: calc(20s / 7 * 4); }
        .carousel .item:nth-child(6) { animation-delay: calc(20s / 7 * 5); }
        .carousel .item:nth-child(7) { animation-delay: calc(20s / 7 * 6); }
